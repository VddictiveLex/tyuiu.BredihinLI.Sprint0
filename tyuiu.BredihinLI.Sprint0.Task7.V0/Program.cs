...
using tyuiu.BredihinLI.Sprint0.Task7.V0.Lib;

namespace tyuiu.BredihinLI.Sprint0.Task7.V0
{
    internal class Program
    {
        static void Main(string[] args)
        {
            Console.Title = "Спринт #0 | Выполнил: Бредихин Л. И. | ИБКСб-25-1";
            ...
            {
                Console.WriteLine("Ошбика! Исходные массивы имеют разное количество элементов");
            }
            Console.ReadKey();
        }
    }
